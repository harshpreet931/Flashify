function initCreateDeck() 
{
    ...
    window.deleteDeck = function(deckName) 
    {
    ...
    window.editDeck = function(deckName) 
    {
    ...
    window.removeCardFromDeck = function(deckName, index) 
    {
    ...
    // Function to add a card to a deck
    window.addCardToDeck = function(deckName) 
    {
        ...
        if(newCard === '')
        {
            alert('Please enter a card to add.');
            return;
        }
